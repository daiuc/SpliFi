...
# work with non-normalized PSI file

suppressMessages(library(tidyverse))

if(interactive()) {
  print("Running in interactive mode")
  FileIn = "/project/yangili1/cdai/SpliFi/code/results/pheno/noisy/GTEx/Lung/separateNoise/leafcutter.phen_chr22.gz"
} else{
...
print("Writing out phenotype PCA results.")
