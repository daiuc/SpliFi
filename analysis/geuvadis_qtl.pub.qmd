...
253 Geuvaids EUR samples are used (see [details](Geuvadis-Samples.pub.qmd)) in this 
...
perm_out_cols = c("pid", "pchr", "pstart", "pend", "pstrand", "num_snp_tested",
                  ...
                  "pval_adj", "qval")
qtls = dir("../code/results/qtl/noise/Geuvadis/EUR/cis_100000/perm", 
...
```{r}
puta_qtls[!is.na(genes)][order(qval)]
```
